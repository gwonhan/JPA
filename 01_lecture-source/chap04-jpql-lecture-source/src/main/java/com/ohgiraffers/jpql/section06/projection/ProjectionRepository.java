...
public class ProjectionRepository {
    ...
    public com.ohgiraffers.jpql.section06.projection.Menu findMenu(int menuCode) {
    ...
    public List<Object[]> scalarQuery() {
        ...
        List<Object[]> resulList = manager.createQuery(jpql).getResultList();
    ...
    public List<CategoryInfoDTO> newProjection() {
        String jpql = "SELECT new com.ohgiraffers.jpql.section06.projection.CategoryInfoDTO(c.categoryCode, categoryName) FROM section06Category c";
