...
public class SimpleJPQLTest {
    ...
    @DisplayName("TypeQuery 를 이용한 단일행 조회 테스트")
    @Test
    ...
    @DisplayName("TypeQuery 를 이용한 다중행 조회 테스트")
    @Test
...
//        menuList.forEach(menu -> System.out.println("menu = " + menu));
    ...
    public void testMultiRowByQuery(){
        ...
        List<Menu> menuList = simpleJPQLRepository.selectMultiRowByQuery();
        Assertions.assertNotNull(menuList);
...
//        menuList.forEach(menu -> System.out.println("menu = " + menu));
    ...
    void testDistinct(){
        ...
        /*메뉴 -> 카테고리 코드*/
        List<Integer>categoryCodeList = simpleJPQLRepository.selectUseDistinct();
