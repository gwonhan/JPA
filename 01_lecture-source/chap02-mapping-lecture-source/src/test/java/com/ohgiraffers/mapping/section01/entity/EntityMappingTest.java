...
public class EntityMappingTest {
    ...
    private static Stream<Arguments> getMember() {
        return Stream.of(
                Arguments.of(1,"user01","pass01","김치맨","010-1234-1234","서울시 노원구", LocalDateTime.now(), "ROLE_MEMBER","Y"),
                Arguments.of(2,"user02","pass02","김이이","010-4321-4321","서울시 마포구", LocalDateTime.now(), "ROLE_ADMIN","Y")
        );
    }
    ...
    @ParameterizedTest
    @MethodSource("getMember")
    void testAccessProperty(int memberNo ,String memberId, String memberPw, String memberName,
